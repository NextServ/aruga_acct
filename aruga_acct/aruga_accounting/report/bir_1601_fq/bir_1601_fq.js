...
frappe.query_reports["BIR 1601-FQ"] = {
    ...
    "onload": function (report) {
        report.page.add_inner_button(__("Print BIR 1601-FQ"), function () {
            ...
            var bir_form_url = frappe.urllib.get_full_url('/api/method/aruga_acct.aruga_accounting.bir_forms.bir_1601_fq?' + u + '&response_type=pdf');
        ...
        report.page.add_inner_button(__("Download QAP"), function () {
            ...
            var bir_form_url = frappe.urllib.get_full_url('/api/method/aruga_acct.aruga_accounting.bir_forms.bir_1601_fq_qap?' + u + '&response_type=download');
            let bir_form = window.open(bir_form_url);
        });
    },
    "formatter": function (value, row, column, data) {
        ...
        // Format tax_rate with percent sign (fallback, as Python already handles this)
